...
for currentTrial = 1:S.GUI.MaxTrials
     load('C:\Users\kepecs\Documents\MATLAB\Bpod\Protocols\StimAirPairing\LightTrain_2s');
...
%% Assemble State matrix
    ...
    sma = AddState(sma, 'Name','PreState',...
        'Timer',S.GUI.PreCue,...
        'StateChangeConditions',{'Tup','ActionSelect'},...
        'OutputActions',{'BNCState',1});
    %Stimulus delivery
   if TrialSequence(currentTrial)==1
    sma=AddState(sma,'Name', 'ActionSelect',...
        'Timer',0,...
        'StateChangeConditions',{'Tup', 'Blank'},...
        'OutputActions', {});
   ...
   elseif TrialSequence(currentTrial)==2
    ...
    sma=AddState(sma,'Name', 'WaitPairing',...
        'Timer',1.5,...
        'StateChangeConditions', {'Tup', 'PostPairing'},...
        'OutputActions', {'BNCState',2}); 
    sma=AddState(sma,'Name', 'PostPairing',...
        'Timer',1,...
        'StateChangeConditions', {'Tup', 'ITI'},...
        'OutputActions', {}); 
