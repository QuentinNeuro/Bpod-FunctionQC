...
if isempty(fieldnames(S))  % If settings file was an 20hZempty struct, populate struct with default settings
...
[S.TrialsNames, S.TrialsMatrix]=Air_Stim_multiFreq_Phase(S.Names.Phase{S.GUI.Phase});  % choose Air_Stim_Pairing
TrialSequence=WeightedRandomTrials(S.TrialsMatrix(:,2)', S.GUI.MaxTrials);
S.NumTrialTypes=max(TrialSequence);
FigLick=Online_LickPlot_Air_Stim_multiFreq('ini',TrialSequence,S.TrialsMatrix,S.TrialsNames,S.Names.Phase{S.GUI.Phase});
...
for currentTrial = 1:S.GUI.MaxTrials
   switch TrialSequence(currentTrial) % Determine trial-specific state matrix fields
        case 1
          load('C:\Users\Kepecs\Documents\Data\Quentin\Bpod\Protocols\PhotoStim_multiFreq\LightTrain_1s.mat');
        case 2
          load('C:\Users\Kepecs\Documents\Data\Quentin\Bpod\Protocols\PhotoStim_multiFreq\LightTrain_2s.mat');
        case 3
          load('C:\Users\Kepecs\Documents\Data\Quentin\Bpod\Protocols\PhotoStim_multiFreq\LightTrain_3s.mat');
        case 4
          load('C:\Users\Kepecs\Documents\Data\Quentin\Bpod\Protocols\PhotoStim_multiFreq\LightTrain_5s.mat');
    end
...
FigLick=Online_LickPlot_Air_Stim_multiFreq('update',[],[],[],[],FigLick,currentTrial,currentOutcome,TrialSequence(currentTrial),currentLickEvents);
if S.GUI.Photometry
