function figData=Online_AudTuningPlot2(action,figtitle,figData,demodDataTW,figID)
...
figData.Tuning.PlotLine2=plot([3.5 3.5],[minyPhoto maxyPhoto],'-b');
    ...
    case 'update'
thisTrial=length(BpodSystem.Data.TrialTypes);
thisTrialType=trialSequence(thisTrial);
Time=demodDataTW(:,1);
NidaqDFF=demodDataTW(:,2);
NidaqRaw=demodDataTW(:,3);
