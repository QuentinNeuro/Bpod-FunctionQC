function Bpod1_TaskParameters_AirStimPairing_1()
%
%
%

global S
    S.Names.Phase={'Licking_training','Habituation','Conditioning','Testing'};
    S.Names.Sound={'Sweep','Tones'};
    S.Names.StateToZero={'Pairing','blank'};   % {'AirPuff','blank'}
    S.Names.OutcomePlot={'Collect','GoNoGo'};
    S.Names.Symbols={'Baseline','Punish','Omission','Small','Inter','Big'};
    S.Names.Rig='Photometry1';
...
%% General Parameters    
    ...
    S.GUIPanels.General={'Phase','MaxTrials','Photometry'};
...
%     S.GUI.OmissionValve=4;
    ...
    S.GUIPanels.Outcome={'RewardValve','Watertime','Pufftime','PunishValve'};
